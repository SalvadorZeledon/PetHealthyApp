    ...
    <View style={styles.container}>
      ...
      >
        <Text style={styles.paragraph}>
          ...
          móvil PetCare. Al utilizar la aplicación, el usuario acepta cumplir
        ...
        <Text style={styles.paragraph}>
          Todo el contenido, diseño, imágenes, código y elementos de PetCare son
        ...
        <Text style={styles.paragraph}>
          PetCare podrá solicitar acceso a la cámara y a la ubicación actual del
          ...
          PetCare no utiliza la cámara ni la ubicación para monitoreo
        ...
        <Text style={styles.paragraph}>
          PetCare se reserva el derecho de modificar o actualizar estos términos
